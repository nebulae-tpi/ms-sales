...
![Intro](docs/images/ms-sales_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [sales](#backend_sales)
        * [Environment variables](#backend_sales_env_vars)
        * [Event Sourcing](#backend_sales_eventsourcing)
        * [CronJobs](#backend_sales_cronjobs)
...
│   ├── sales                     => Micro-BackEnd responsible for ...
...
## sales <a name="backend_sales"></a>
...


### Environment variables <a name="backend_sales_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/sales/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-sales.yaml)

### Event Sourcing <a name="backend_sales_eventsourcing"></a>
...
### CronJobs <a name="backend_sales_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpi/ms-sales.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpi/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-sales/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-sales/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-sales/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-sales/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-sales/backend/sales/.env   *WORKING_FOLDER*/ms-sales/playground/emi-gateway/.env  
